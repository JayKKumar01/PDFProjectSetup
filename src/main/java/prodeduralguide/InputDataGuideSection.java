...
public class InputDataGuideSection {
...
//        addStyledParagraph(doc, "📘 Input Data Excel Sheet Setup Guide", 20, true, "004670");
        ...
        // 📁 File Location Note
        addStyledParagraph(doc, "📁 Where to Find SampleInputData.xlsx?", 13, true, "007377");
        addBodyText(doc, "A sample Excel file named SampleInputData.xlsx is placed in your workspace folder. "
                + "Please take a look at this file along with this guide to understand how to structure your own input data sheet.");
